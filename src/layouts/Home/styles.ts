...
box-shadow: 1px 1px 3px rgba(0,0,0,.5), -1px -1px 3px rgba(0,0,0,.3);
...
box-shadow: 1px 1px 3px rgba(0,0,0,.2), -1px -1px 5px rgba(0,0,0,.5);
padding: 2rem 1rem;

h2 {
   font-size: 2rem;
   background-image: linear-gradient(90deg, transparent, #614385 3%, transparent);
   border-radius: 5px;
   padding: 2px 10px;
   margin-bottom: 3rem;
   font-weight: 600;
